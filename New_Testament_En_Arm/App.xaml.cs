...
namespace NewTestamentEnArm
{
    ...
    public sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            UnhandledException += MyUnhandledExceptionEventHandler;


        }
        public static void MyUnhandledExceptionEventHandler(object sender, Windows.UI.Xaml.UnhandledExceptionEventArgs e)
        {
            e.Handled = false;
            Dbg.d(e.Exception.StackTrace);
            LogMessageToFile(e.Exception.ToString(), LoggingLevel.Error);
        }

        private static FileLoggingSession fileLoggingSession;
